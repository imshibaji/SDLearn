...
<div class="row">
    <div class="col-md-8">
        <div class="mb-2"><input type="text" class="form-control form-control-lg" name="title" placeholder="Input Title"></div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="form-group row">
               <div class="col-md-8"><input type="date" name="sending_date" class="form-control" id="sending_time"></div>
               <div class="col-md-4"><input type="time" name="sending_time" class="form-control" id="sending_time"></div>
            </div>
        </div>
        <div class="form-group">
            <label for="expaire_at">Expaire DateTime</label>
            <div class="form-group row">
                <div class="col-md-8"><input type="date" name="expaire_date" class="form-control" id="expaire_at"></div>
                <div class="col-md-4"><input type="time" name="expaire_time" class="form-control" id="expaire_at"></div>
             </div>
        </div>
        <div class="form-group">
