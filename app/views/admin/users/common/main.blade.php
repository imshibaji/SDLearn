        ...
        <div class="row">
            <div class="col">
                <div class="c-callout c-callout-success b-t-1 b-r-1 b-b-1">
                    ...
                    <strong class="h4">{{ $user->created_at }}</strong>
                </div>
            </div>
            <div class="col">
                <div class="c-callout c-callout-primary b-t-1 b-r-1 b-b-1">
                    <small class="text-muted">Last Updated</small><br>
                    <strong class="h4">{{ $user->updated_at }}</strong>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col">
                <div class="c-callout c-callout-warning b-t-1 b-r-1 b-b-1">
                    <small class="text-muted">Withdrawal</small><br>
            ...
            <div class="col">
                <div class="c-callout c-callout-info b-t-1 b-r-1 b-b-1">
                    ...
                    <strong class="h4">{{ $user->money[0]->details ?? 0 }}</strong>
                </div>
            </div>
        </div>
        {{-- End --}}
